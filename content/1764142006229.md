...
$p(s'|s,a)$: Markov kernel / Transition probability.$$P(s'|s,a) = \mathbb{P}(S_{t+1}=s' | S_t=s, A_t=a)$$  
...
$$\mathbb{E}[h(s')] = 1 - \|\mu\|^2 - 0.2 \quad (\text{since } \text{Tr}(0.1I_{2\times2}) =0.1+0.1= 0.2)$$
